function [ outP, outN ] = genModReplay( audio_file, segN, initP )
% generate the modulated replay segments from the recorded modulated replay audio.
...
% output: outP - findP of the modulated replay audio.
%         outN - findN of the modulated replay audio.
% Shu Wang

%% TEST
% clear;
% close all;
% audio_file = './samples/samples_modreplay.wav';
% segN = 6;
% %initP = 2.8*10^5;
% initP = 0;
